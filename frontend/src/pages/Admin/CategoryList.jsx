    ...
    return (
        <div className="ml-[10rem] flex flex-col md:flex-row">
            ...
            <div className="md:w-3/4 p-3">
                ...
                <CategoryForm value={name} setvValue={setName} handleSubmit={handleCreateCategory} />
                <br />
                <hr />
                ...
                <Modal isOpen={modalVisible} onClose={() => setModalVisible(false)}>
                    <CategoryForm value={updatingName} setvValue={setUpdatingName} handleSubmit={handleUpdateCategory} buttonText="Update" handleDelete={handleDeleteCategory} />
                </Modal>
